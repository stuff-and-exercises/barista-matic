...
/**
 * Abstract class for ingredients. Extends Drink so we can decorate them with multiple ingredients.
 *
 * Every ingredient has a drink which is decorating, and a price. The price is an int and it is in
 * cents ($1.00 = 100).
 */
